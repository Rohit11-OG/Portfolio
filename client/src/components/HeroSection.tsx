        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          ...
          <div className="space-y-8 text-left">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 mb-4 animate-slide-in-up stagger-1 rounded-full border border-primary/25 bg-primary/5 px-4 py-1.5">
                <Sparkles className="h-4 w-4 text-primary" />
                <span className="text-sm font-medium text-primary tracking-wide">AI Engineer @ IRDPL • Computer Vision • Deep Learning</span>
              </div>

              <div className="space-y-4">
                <h1 className="text-5xl md:text-7xl font-bold leading-[1.05] tracking-tight animate-fade-in-scale stagger-2">
                  <span className="bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">
                    Rohit
                  </span>
                  <br />
                  <span className="text-foreground">Mandwade</span>
                </h1>
                ...
                <div className="space-y-3">
                  <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl leading-relaxed animate-slide-in-up stagger-2">
                    ...
                    <span className="text-primary font-semibold"> Computer Vision and Machine Learning </span>
                    for robotic automation
                  </p>
                  <p className="text-lg text-muted-foreground max-w-xl leading-relaxed animate-slide-in-up stagger-3">
                    Building <span className="text-foreground font-medium">production-grade ML models</span>,
                    <span className="text-foreground font-medium"> real-time vision systems</span>, and
                    <span className="text-foreground font-medium"> end-to-end AI solutions</span> for intelligent automation
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4 animate-slide-in-up stagger-3">
              <Button 
                ...
                size="lg"
                className="bg-gradient-to-r from-primary to-accent button-ripple magnetic-button relative overflow-hidden group transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-primary/25 border border-primary/30"
              ...
              <Button 
                ...
                size="lg"
                className="border-primary/30 text-primary hover:bg-primary/10 magnetic-button button-ripple relative overflow-hidden group transition-all duration-300 hover:border-primary/60"
            ...
            <div className="flex items-center space-x-6 pt-4 animate-slide-in-up stagger-4">
              <a href="https://github.com/Rohit11-OG" target="_blank" rel="noopener noreferrer">
                <Button 
                  size="icon" 
                  variant="ghost" 
                  className="hover:bg-primary/20 hover:text-primary magnetic-button relative overflow-hidden group transition-all duration-500 rounded-full border border-transparent hover:border-primary/30"
